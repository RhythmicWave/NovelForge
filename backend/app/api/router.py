...
from app.api.endpoints import consistency as consistency_ep
...
api_router.include_router(consistency_ep.router, prefix="/consistency", tags=["consistency"]) 
