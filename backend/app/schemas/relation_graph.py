...
class RelationGraphInput(BaseModel):
    ...
    kind_cn: Optional[str] = Field(default=None, description="关系中文类型")
    kind: Optional[str] = Field(default=None, description="关系中文类型（兼容字段）")
    ...
    stance: Optional[str] = Field(default=None, description="立场：友好/中立/敌意")
...
class RelationGraphBatchUpdateKindRequest(BaseModel):
    ...
    new_kind_cn: Optional[str] = Field(default=None, description="新的关系中文类型")


class RelationGraphBatchUpdateStanceRequest(BaseModel):
    project_id: int
    keys: List[RelationGraphKey] = Field(default_factory=list)
    stance: Optional[str] = Field(default=None, description="新立场")
